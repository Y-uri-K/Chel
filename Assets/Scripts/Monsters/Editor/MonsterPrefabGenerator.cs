...
public class MonsterPrefabGenerator : EditorWindow
{
    ...
    static void ApplyBaseStats(MonsterStats stats, string name)
    {
        switch (name)
        {
            case "FlyingEye":  stats.SetBaseStats(60, 10, 240f, 140f, 1.0f, 500f, 250f); break;
            case "Goblin":     stats.SetBaseStats(90, 12, 200f, 120f, 1.3f, 420f, 200f); break;
            case "Mushroom":   stats.SetBaseStats(130, 18, 140f, 110f, 1.6f, 350f, 170f); break;
            case "Skeleton":   stats.SetBaseStats(80, 14, 160f, 130f, 1.1f, 450f, 220f); break;
            case "StoneGolem": stats.SetBaseStats(250, 30, 220f, 300f, 2.0f, 2400f, 1200f); break;
            case "DemonSlime": stats.SetBaseStats(200, 22, 180f, 250f, 1.5f, 600f, 300f); break;
            case "Minotaur":   stats.SetBaseStats(180, 25, 160f, 160f, 1.8f, 500f, 250f); break;
            case "FlyingDemon": stats.SetBaseStats(120, 15, 150f, 275f, 1.5f, 700f, 350f); break;
        }
    }
